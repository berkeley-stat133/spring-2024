...
If you are on the waiting list, you must still do all coursework and complete labs and homework by the deadlines. __We will not be offering extensions if you are admitted into the course later.__ So it is your responsibility to stay up to date on the assignments.
...
__Requesting an extension__: If you need to request an extension, regardless of your DSP status, fill out this **form** (TBD). Submissions to this form will be visible only to the course staff members.
